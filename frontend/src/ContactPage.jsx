...
function ContactPage() {
    ...
    return (
        <>
            <Helmet>
                <title>Contact | Gunnar Knox</title>
                <meta
                    name="description"
                    content="Get in touch with Gunnar Knox, full stack web developer. Reach out for collaborations, job opportunities, or questions about projects and web development skills."
                />
            </Helmet>
